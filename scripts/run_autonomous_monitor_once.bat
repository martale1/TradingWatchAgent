...
if "%OPENAI_PERIODIC_MODEL%"=="" set OPENAI_PERIODIC_MODEL=gpt-5-mini
if "%OPENAI_PERIODIC_MAX_TURNS%"=="" set OPENAI_PERIODIC_MAX_TURNS=24
if "%OPENAI_AGENT_MAX_OUTPUT_TOKENS%"=="" set OPENAI_AGENT_MAX_OUTPUT_TOKENS=6000
if "%OPENAI_PERIODIC_CONDITION_LIMIT%"=="" set OPENAI_PERIODIC_CONDITION_LIMIT=8
